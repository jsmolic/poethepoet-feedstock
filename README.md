...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/poethepoet-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/poethepoet-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install poethepoet
```
...
It is possible to list all of the versions of `poethepoet` available on your platform:
...
```
pixi search poethepoet --channel conda-forge
```
